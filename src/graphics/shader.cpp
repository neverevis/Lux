...
Lux::Graphics::Shader::Shader(const char* vert_path, const char* frag_path){
...
Lux::Graphics::Shader::~Shader(){
    gl::DeleteProgram(id_);
}

void Lux::Graphics::Shader::use(){
    gl::UseProgram(id_);
}
...
void Lux::Graphics::Shader::check_linking_errors(){
    GLint success;
